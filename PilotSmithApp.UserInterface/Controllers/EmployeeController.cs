...
namespace PilotSmithApp.UserInterface.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult CheckEmployeeCodeExist(EmployeeViewModel employeeVM)
        {
            ...
            if (exists)
            {
                return Json("<p><span style='vertical-align: 2px'>Employee Code already is in use </span> <i class='fa fa-times' style='font-size:19px; color: red'></i></p>", JsonRequestBehavior.AllowGet);
            }
