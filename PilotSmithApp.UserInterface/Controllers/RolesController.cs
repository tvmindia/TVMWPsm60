...
namespace PilotSmithApp.UserInterface.Controllers
{
    public class RolesController : Controller
    {
        ...
        public string InsertUpdateRoles(RolesViewModel rolesObj)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (rolesObj.ID == Guid.Empty)
                {
                    try
                    {
                        rolesObj.commonDetails = new PSASysCommonViewModel();
                        rolesObj.commonDetails.CreatedBy = _appUA.UserName;
                        rolesObj.commonDetails.CreatedDate = _appUA.LoginDateTime;
                ...
                else
                {
                    try
                    {
                        ...
                        rolesObj.commonDetails.UpdatedDate = _appUA.LoginDateTime;
        ...
        public ActionResult ChangeButtonStyle(string ActionType)
        {
            ...
            Permission _permission = _pSASysCommon.GetSecurityCode(appUA.UserName, "Roles");
