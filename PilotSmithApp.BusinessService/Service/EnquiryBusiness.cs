...
namespace PilotSmithApp.BusinessService.Service
{
    public class EnquiryBusiness:IEnquiryBusiness
    {
        ...
        public object InsertUpdateEnquiry(Enquiry enquiry)
        {
            ...
            {
                enquiry.DetailXML = _commonBusiness.GetXMLfromEnquiryObject(enquiry.EnquiryDetailList, "ProductID,ProductModelID,Qty,UnitCode,Rate");
            }
        ...
        {
            return _enquiryRepository.GetEnquiryCountSummary();
        }
    }
}
